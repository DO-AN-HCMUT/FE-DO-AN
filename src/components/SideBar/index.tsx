...
export default function SideBar() {
  return (
    <div className='h-full w-[15%] cursor-pointer border-r-[1px] border-[#ccc] px-2 py-4'>
      ...
      <Link className='mb-3 flex items-center rounded-lg px-4 py-2 hover:bg-primary hover:text-white' href='/projects'>
        <Image src='/images/sideBar/dashboard.png' alt='projects' width={20} height={20} className='me-3' />
        <p>Projects</p>
      </Link>
      <div className='mb-3 flex items-center rounded-lg px-4 py-2 hover:bg-primary hover:text-white'>
